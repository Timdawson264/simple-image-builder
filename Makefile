...
# k8s.tdawson.co.nz/simple-image-builder-bundle:$VERSION and k8s.tdawson.co.nz/simple-image-builder-catalog:$VERSION.
IMAGE_TAG_BASE ?= k8s.tdawson.co.nz/simple-image-builder
...
IMG ?=  quay.io/tidawson/simple-image-builder:latest
